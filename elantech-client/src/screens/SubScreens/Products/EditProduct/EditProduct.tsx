...
import { BoxSeam, Floppy, InfoCircle, Link45deg, Save, Tag } from 'react-bootstrap-icons';
import { typeOptions, brandOptions } from "../../../../constants/Options";
import { defaultAlert, defaultProduct } from "../../../../constants/Defaults";
import IProduct from "../../../../types/IProduct";
import { requestUpdateProduct } from "../../../../utils/Requests";
...
export const EditProductLayout: FunctionComponent<RouteComponentProps<{}, {}, LocationState>> = (props) => {
    const sectionRef = useRef<HTMLElement>(null);
    const [isSaving, setIsSaving] = useState(false);
    const [alert, setAlert] = useState(defaultAlert);
    const [customErrors, setCustomErrors] = useState<Record<string, string>>({});
    const [product, setProduct] = useState<IProduct>(props.location.state?.product || defaultProduct);
    ...
    const handleProduct = async (product: IProduct) => {
        ...
        try {
            ...
            setTimeout(() => {
                history.push({
                    pathname: PAGE_ROUTES.EDIT_PRODUCT_SUCCESS,
                    state: { product }
                });
            }, 1500);
        } catch (error) {
        ...
        <section ref={sectionRef} className="text-white main-section overflow-auto">
            <Container className="py-4">
                <div className="mb-4">
                    ...
                    <h2 style={{ fontWeight: 300, marginBottom: 0 }}>Edit Product</h2>
...
export const EditProduct = withRouter(EditProductLayout);
