...
import { BoxSeam, Hash, InfoCircle, Link45deg, Tag } from "react-bootstrap-icons";
        ...
        <section ref={sectionRef} className="text-white main-section overflow-auto">
            <Container className="py-4">
                <div className="mb-4">
                    ...
                    <h2 style={{ fontWeight: 300, marginBottom: 0 }}>Add Inventory</h2>
                    <p className="text-muted">Please enter inventory information.</p>
                </div>
                    ...
                    >
                        <div className="mb-1" style={{ background: 'linear-gradient(to bottom, rgba(40, 167, 69, 0.2), transparent)', padding: '1rem', borderRadius: '0.25rem' }}>
                            <div className="d-flex align-items-center mb-2">
                                <Hash size={25} />
                                <h5 className="mb-0 ms-2" style={{ fontWeight: 300 }}>SKU Configuration</h5>
                            </div>
                            <p className="text-muted">Choose how to manage your product SKUs</p>
                        </div>
